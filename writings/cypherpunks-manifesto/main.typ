#set page(width: 16cm, height: auto, margin: (x: 2cm, y: 2.5cm))
...
#v(1em)
#align(right)[_Onward._]

#v(2em)
#line(length: 4cm, stroke: 0.5pt + luma(180))
#v(0.5em)
#text(size: 9pt, fill: luma(120))[
  Eric Hughes #h(1em) #link("mailto:hughes@soda.berkeley.edu")[hughes\@soda.berkeley.edu]
]
